                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group row">
                                <label for="middleName" class="col-md-4 col-form-label text-md-right">{{ __('Middle
                                    Name')
                                    }}</label>
                            ...
                            <div class="form-group row">
                                <label for="zipCode" class="col-md-4 col-form-label text-md-right">{{ __('Zip Code')
                                    }}</label>
                            ...
                            <div class="form-group row">
                                <label for="birthDate" class="col-md-4 col-form-label text-md-right">{{ __('Birthdate')
                                    }}</label>
                            ...
                            <div class="form-group row">
                                <label for="dateHired" class="col-md-4 col-form-label text-md-right">{{ __('Date Hired')
                                    }}</label>
